...
\newcommand{\getAvg}[3]{
	\pgfplotstableread[col sep=comma]{C:/Users/nalo/Desktop/TestsCopy/RenamedFrameTime#1/#3#2#1_run1_Log.csv}\datafile
    	\pgfplotstablegetelem{0}{RenderAvg}\of\datafile
	\pgfmathsetmacro{\testValA}{\pgfplotsretval}
	\pgfplotstableread[col sep=comma]{C:/Users/nalo/Desktop/TestsCopy/RenamedFrameTime#1/#3#2#1_run2_Log.csv}\datafile
  	\pgfplotstablegetelem{0}{RenderAvg}\of\datafile
	\pgfmathsetmacro{\testValB}{\pgfplotsretval}
	\pgfplotstableread[col sep=comma]{C:/Users/nalo/Desktop/TestsCopy/RenamedFrameTime#1/#3#2#1_run3_Log.csv}\datafile
    	\pgfplotstablegetelem{0}{RenderAvg}\of\datafile
...
% 1: recursions, 2: Scene
\newcommand{\getDecrease}[2]{
	100.0-100.0*\getlabel{Polarized#2#1}/\getlabel{Baseline#2#1}
}
